...
<div class="portraits-page">
  <div class="portraits">
        ...
        <h4 class="card-title">Nux</h4>
        </div>
        </div>

        <div class="card">
        <img class="card-img-top" src="../assets/Images/portraits/nux2.jpg" alt="Nux">
        <div class="card-img-overlay">
        <h4 class="card-title">Nux</h4>
        </div>
        </div>
        ...
        <div class="card-img-overlay">
        <h4 class="card-title">Linkin Park - Chester Bennington</h4>
        </div>
        </div>
        ...
        <div class="card-img-overlay">
        <h4 class="card-title">Black Panther Cosplay - Cutiepiesensei</h4>
        </div>
        </div>
